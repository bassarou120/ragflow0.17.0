...
class PersoTemplateParam(ComponentParamBase):
    """
    ...
    def check(self):
        self.check_empty(self.content, "[PersoTemplate] Content")
        return True


class PersoTemplate(ComponentBase):
    component_name = "PersoTemplate"
    ...
    def _run(self, history, **kwargs):
      ...
      #  for n, v in kwargs.items():
        ...
        print('--------------------------------------')
        print('#######################################')
        print(PersoTemplate.be_output(content))
        print('##################################')
        return PersoTemplate.be_output(content)
